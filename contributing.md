# Contributing to expand-reflinks

First and foremost, thank you! We appreciate that you want to contribute to expand-reflinks, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for expand-reflinks**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for expand-reflinks:

- star the [project](https://github.com/jonschlinkert/expand-reflinks)
- tweet your support for expand-reflinks
...
- **version**: please note the version of expand-reflinks are you using
...
[so]: http://stackoverflow.com/questions/tagged/expand-reflinks